  ...
  <div class="mt-10">
    ...
    <div class="grid grid-cols-3 justify-between mt-10">
      <div class="block">
        ...
        <label for="price">
          <input id="price" class="w-1/4 mt-2 text-base rounded shadow h-10 px-5 pb-1 focus:outline-none"
...
<script>
  ...
  import FileUpload from '@/components/catalog/NewListing/FileUpload'
    ...
    export default {
        ...
        computed: {
          ...mapGetters("listing",["getConditions"])
        },
        methods: {
          ...mapActions("listing",["loadConditions"])
        }
    }
