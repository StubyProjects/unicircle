    ...
    <div>
      ...
      <div>
        ...
        <div class="mt-3 flex justify-between ">
          <button class="font-bold shadow rounded block hover:bg-primary px-4 py-2" @click="$refs.images.click()">Bilder auswählen</button>
        </div>

        <div class="grid grid-cols-4 gap-4 mt-5">
          <div class="relative" v-for="(image, index) in getProductImages">
            <button style="top: -10px" class="shadow font-bold absolute right-0 bg-white hover:bg-primary rounded-full p-2" @click="deleteImage(image, index)">
